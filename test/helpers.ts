...
import type { DomainDependencies } from "../src/domain/types.js";
...
const FIXTURE_DIR = join(dirname(fileURLToPath(import.meta.url)), "fixtures/sleeper");
...
export async function createFixtureFetch(overrides: Record<string, unknown> = {}): Promise<FetchLike> {
