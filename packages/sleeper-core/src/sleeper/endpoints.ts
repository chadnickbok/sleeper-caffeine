...
export class SleeperApi {
  ...
  getRosters(leagueId: string) {
    return this.client.get(
      `/league/${segment(leagueId)}/rosters`,
      RostersSchema,
    );
  }
  ...
  getMatchups(leagueId: string, week: number) {
    return this.client.get(
      `/league/${segment(leagueId)}/matchups/${week}`,
      MatchupsSchema,
    );
  }
  ...
  getTransactions(leagueId: string, week: number) {
    return this.client.get(
      `/league/${segment(leagueId)}/transactions/${week}`,
      TransactionsSchema,
    );
  }
  ...
  getTradedPicks(leagueId: string) {
    return this.client.get(
      `/league/${segment(leagueId)}/traded_picks`,
      TradedPicksSchema,
    );
  }
  ...
  getWinnersBracket(leagueId: string) {
    return this.client.get(
      `/league/${segment(leagueId)}/winners_bracket`,
      BracketSchema,
    );
  }
  ...
  getLosersBracket(leagueId: string) {
    return this.client.get(
      `/league/${segment(leagueId)}/losers_bracket`,
      BracketSchema,
    );
  }
}
